...
ConfigDescription config_entry_psychovisual[] = {
    ...
    {NOISE_ADAPTIVE_FILTERING_TOKEN, "Control noise detection for CDEF/restoration filtering, default is 2 [0: off, 1: both CDEF and restoration are on 2: default tune behavior, 3: CDEF only, 4: restoration only)]"},
    // Termination
    {NULL, NULL}};
