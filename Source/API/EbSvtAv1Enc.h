...
typedef struct EbSvtAv1EncConfiguration {
    ...
    * Default is 0. */
    ...
    /**
     * @brief Tune for a particular metric; 0: VQ, 1: PSNR, 2: SSIM, 3: IQ (Image Quality), 4: MS_SSIM, 5: VMAF, 6: Film Grain.
     *
     * Default is 1.
     */
    uint8_t tune;
    ...
    *  Default is 0. */
    ...
    uint8_t padding[128 - sizeof(PredStructure) +
        ...
        - sizeof(bool) // enable_intrabc
                    ...
                    - (sizeof(uint8_t) * 9) - (sizeof(int8_t) * 1) - (sizeof(int32_t) * 1) - (sizeof(bool) * 3) -
                    (sizeof(double))
    ];
    // clang-format on
