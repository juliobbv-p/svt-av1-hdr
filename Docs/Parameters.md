...
| **Noise**                        | --noise                | [ 0 - 100]     |  0          | Generate noise table for film grain, default is 0 [0: off, 1-100: strength value]                                                                                     |
...
| **NoiseSize**                    | --noise-size           | [-1 - 13]      | -1          | Set size of noise grain, default is -1 [-1: auto, 0-13: set grain size]                                                                                               |
